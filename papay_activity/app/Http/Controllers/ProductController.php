...
class ProductController extends Controller
{
    ...
    private function syncProductsToLocal()
    {
        ...
        // Save JSON
        Storage::disk('papay_activity')->put("$jsonFolder/products.json", $products->toJson(JSON_PRETTY_PRINT));

        // Save XML
        $xmlContent = $this->convertToXml($products, 'products', 'product');
        Storage::disk('papay_activity')->put("XML/$xmlFolder/products.xml", $xmlContent);
    }
