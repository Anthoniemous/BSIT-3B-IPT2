    ...
    <div class="main-content">
        @if(isset($products) && $products->count() > 0)
            ...
            <div class="product-card">
                ...
                {{-- 👇 FIXED: Gamiton ang CSS classes para sa alignment --}}
                <div class="product-card-footer" style="display: flex; justify-content: center; align-items: center; gap: 10px; padding: 10px;">
