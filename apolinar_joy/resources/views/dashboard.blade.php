...
<body>
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <!-- NEW ARRANGEMENT: Recent Orders at Top (moved from bottom) -->
            ...
            <!-- Product Performance Section (moved up, was at middle-bottom) -->
            ...
            <section class="charts-section">
                ...
                <!-- Order Status Distribution (top right) -->
                <div class="chart-container medium">
                    <div class="chart-header">
                ...
                <!-- Empty spot for balance (bottom right) - you can add another chart here later -->
                <div class="chart-container medium" style="display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #FCE4EC 0%, #F8BBD0 100%);">
                    <div style="text-align: center; color: #C2185B;">
                        <div style="font-size: 4rem; margin-bottom: 1rem;">📊</div>
                        <h3 style="font-family: var(--font-display); font-size: 1.5rem; margin-bottom: 0.5rem;">Additional Chart Space</h3>
                        <p style="color: #AD1457;">Perfect spot for future analytics!</p>
                    </div>
                </div>
            </section>
        </main>
    ...
    <script>
        ...
        // Chart colors - Updated to pink theme
        const chartColors = {
            primary: '#E91E63',
            secondary: '#F48FB1',
            tertiary: '#F8BBD0',
        ...
        new Chart(orderStatusCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: [chartColors.primary, chartColors.secondary, chartColors.tertiary, chartColors.accent],
                    borderWidth: 0
                }]
            },
            options: {
