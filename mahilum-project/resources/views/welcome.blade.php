...
<body>
    ...
    <div class="container header-inner">
      ...
      <nav class="main-nav">
        <ul>  
          ...
          <li><a href="{{ url('/userdashboard') }}">Menu</a></li>
        </ul>
      </nav>
  ...
  <section class="hero container">
    <div class="hero-inner">
      <div class="hero-copy">
        <h1>Freshly Brewed Coffee Awaits!</h1>
        <p class="lead">
          Experience the rich aroma and smooth flavors of Brew Haven — your perfect cup, every time.
        </p>
        <div class="hero-ctas">
          <a href="{{ route('user.dashboard') }}" class="btn cta">Order Now</a>
          <a href="#featured" class="text-link">Explore Favorites</a>
        </div>
      </div>
      <div class="hero-media">
        <img id="hero-img" src="{{ asset('css/img/2.png') }}" alt="Coffee Cup">
      </div>
    </div>
  </section>
