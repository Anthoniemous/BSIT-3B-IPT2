...
<head>
    ...
    <title>Brew Haven - Coffee Analytics</title>
    <link rel="stylesheet" href="{{ asset('css/admindashboard.css') }}">
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;600;700;800&family=Roboto:wght@400;500;700&display=swap" rel="stylesheet">
...
<body>
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            <div class="logo">
                <h1>☕ BREW HAVEN<span>COFFEE ANALYTICS</span></h1>
            </div>
            <nav class="nav-menu">
        ...
        <main class="main-content">
            <header class="page-header">
                <div class="header-content">
                    <h1 class="page-title">☕ Coffee Store Analytics</h1>
                    <p class="page-subtitle">Track your coffee business performance in real-time</p>
                </div>
            ...
            <section class="metrics-grid">
                ...
                <div class="metric-card" data-metric="cancelled">
                    ...
                    <div class="metric-trend negative">↓ Items</div>
                </div>
                ...
                <div class="metric-card" data-metric="categories">
                    ...
                    <div class="metric-content">
                        ...
                        <p class="metric-label">Coffee Categories</p>
                    </div>
    ...
    <script>
        ...
        function viewOrderItems(orderId) {
            ...
            let itemsHtml = '<table class="modal-table"><thead><tr><th>Coffee</th><th>Quantity</th><th>Price</th><th>Subtotal</th></tr></thead><tbody>';
