    ...
    <div @click.away="addModal = false"
        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="category_id" class="w-full border border-gray-300 px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400" required>
            </div>
...
<div x-show="editModal"
    ...
    <div @click.away="editModal = false"
        ...
        <form :action="`{{ url('admin/products/update') }}/${selected.product_id}`" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label class="block font-semibold mb-1">Category ID</label>
                <input type="number" name="category_id" x-model="selected.category_id"
