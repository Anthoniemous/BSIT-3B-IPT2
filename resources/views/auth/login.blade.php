<x-guest-layout>
    ...
    <div class="flex flex-col items-center mt-6 space-y-3">
        ...
        @if(Route::has('google-auth'))
            <a href="{{ route('google-auth') }}" class="flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                <img src="https://developers.google.com/identity/images/g-logo.png" class="w-5 h-5 mr-2" alt="Google" onerror="this.style.display='none'">
