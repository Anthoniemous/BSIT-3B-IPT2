...
<head>
  ...
  <style>
    ...
    .tabs button.active { border-bottom: 2px solid #007BFF; background: #fff; }
    ...
    .form-container button { padding: 10px; border: none; background: #007BFF; color: #fff; border-radius: 4px; cursor: pointer; }
