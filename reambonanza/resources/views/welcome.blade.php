...
<head>
  ...
  <style>
    ...
    .tabs button.active { border-bottom: 2px solid #1b5c25; background: #fff; }
    ...
    .form-container button { padding: 10px; border: none; background: #1b5c25; color: #fff; border-radius: 4px; cursor: pointer; }
    .form-container button:hover { background: #4caf50; }
    .error-msg p, .success-msg { color: red; font-size: 14px; margin-bottom: 5px; }
    .success-msg { color: green; }
    .links { font-size: 13px; margin-top: 10px; }
    .links a { color: #1b5c25; text-decoration: none; }
...
<body>
  ...
  <section class="hero container">
    <div class="hero-inner">
      <div class="hero-copy">
        <h1>Healthy, Shiny Hair Awaits!</h1>
        <p class="lead">
          Discover the natural shine and nourishment with Green Glow Shampoo — your hair’s perfect care partner.
        </p>
        <div class="hero-ctas">
          <a href="{{ route('user.dashboard') }}" class="btn cta">Shop Now</a>
          <a href="#featured" class="text-link">Explore Favorites</a>
        </div>
      </div>
  ...
  <section class="features container">
    <div class="feature-card">
      ...
      <div class="feature-copy"><strong>Fast Delivery</strong><span>Get your shampoo quickly at your door</span></div>
    </div>
    <div class="feature-card">
      <i class="fa fa-leaf"></i>
      <div class="feature-copy"><strong>Natural Ingredients</strong><span>Gentle and nourishing for all hair types</span></div>
    </div>
    <div class="feature-card">
      <i class="fa fa-bath"></i>
      <div class="feature-copy"><strong>Premium Quality</strong><span>Formulated by hair care experts</span></div>
    </div>
    <div class="feature-card">
      <i class="fa fa-credit-card"></i>
      <div class="feature-copy"><strong>Secure Payment</strong><span>Safe and convenient checkout</span></div>
    </div>
  </section>
