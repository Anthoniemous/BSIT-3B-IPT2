...
<body>
  ...
  <header>
    <div class="logo">MotorParts Hub</div>
    <nav>
      <ul>
        <li><a href="#">Home</a></li>
  ...
  <section class="hero">
    <h1>Welcome to MotorParts Dashboard</h1>
  </section>

  <div class="content">
    <h2>Store Overview</h2>
    <p>
      This is a simple dashboard layout converted from the Feane template, now customized for a MotorParts shop.  
